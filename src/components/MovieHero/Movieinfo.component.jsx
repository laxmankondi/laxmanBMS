    ...
    return (
        <>
          <div className="flex flex-col gap-3 lg:gap-8 ">
              ...
              <h1 className="text-white text-5xl font bold hidden lg:block">Godzilla vs. Kong</h1>
              <div className="flex flex-col-reverse gap-3 lg:gap-5 lg:flex-col">
              <div className="text-white font-light flex flex-col gap-1 md:px-4 ">
                  <h4>4k &bull; English &bull; Action </h4>
                  <h4>1h 53m &bull; Drama &bull; 13+ &bull; 24Mar, 2021 </h4>
              </div>
